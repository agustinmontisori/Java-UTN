...
CREATE TABLE `consumo_paciente` (
  ...
  `id_alimento` int unsigned NOT NULL,
  PRIMARY KEY (`fecha_hora`,`id_paciente`,`id_alimento`),
  KEY `fk_consumo_paciente_alimento_idx` (`id_alimento`),
  KEY `fk_consumo_paciente_idx` (`id_paciente`),
  CONSTRAINT `fk_consumo_paciente` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`dni`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_consumo_paciente_alimento` FOREIGN KEY (`id_alimento`) REFERENCES `alimento` (`id_alimento`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `consumo_paciente` VALUES ('2020-07-13 23:22:27',3,1111111,0),('2020-07-13 23:22:28',200,1111111,1),('2020-07-13 23:22:29',500,2222222,1),('2020-07-13 23:22:30',50,2222222,2),('2020-07-13 23:22:31',2,4124412,0),('2020-07-13 23:23:22',5,4124412,0);
...
-- Dump completed on 2020-07-13 23:26:56
