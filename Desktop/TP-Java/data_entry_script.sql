...
insert into solicitud (id_nutricionista, id_paciente, estado_solicitud) values (12312, 4124412, 'confirmada');
...
insert into consumo_paciente (id_paciente, id_alimento, fecha_hora, cantidad) values (1111111, 0, now(), 3);
insert into consumo_paciente (id_paciente, id_alimento, fecha_hora, cantidad) values (1111111, 1, now(), 200);
insert into consumo_paciente (id_paciente, id_alimento, fecha_hora, cantidad) values (2222222, 1, now(), 500);
insert into consumo_paciente (id_paciente, id_alimento, fecha_hora, cantidad) values (2222222, 2, now(), 50);
insert into consumo_paciente (id_paciente, id_alimento, fecha_hora, cantidad) values (4124412, 0, now(), 2);
insert into consumo_paciente (id_paciente, id_alimento, fecha_hora, cantidad) values (4124412, 0, now(), 5);
